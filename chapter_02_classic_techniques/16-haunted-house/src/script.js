...
// const floorColorTexture = textureLoader.load('./floor/gray_rocks_1k/gray_rocks_diff_1k.webp')
// const floorARMTexture = textureLoader.load('./floor/gray_rocks_1k/gray_rocks_arm_1k.webp')
// const floorNormalTexture = textureLoader.load('./floor/gray_rocks_1k/gray_rocks_nor_gl_1k.webp')
// const floorDisplacementTexture = textureLoader.load('./floor/gray_rocks_1k/gray_rocks_disp_1k.webp')

const floorColorTexture = textureLoader.load('./floor/aerial_rocks_01_1k/aerial_rocks_01_diff_1k.webp')
const floorARMTexture = textureLoader.load('./floor/aerial_rocks_01_1k/aerial_rocks_01_arm_1k.webp')
const floorNormalTexture = textureLoader.load('./floor/aerial_rocks_01_1k/aerial_rocks_01_nor_gl_1k.webp')
const floorDisplacementTexture = textureLoader.load('./floor/aerial_rocks_01_1k/aerial_rocks_01_disp_1k.webp')
...
const wallColorTexture = textureLoader.load('./wall/castle_wall_slates_1k/castle_wall_slates_diff_1k.webp')
const wallARMTexture = textureLoader.load('./wall/castle_wall_slates_1k/castle_wall_slates_arm_1k.webp')
const wallNormalTexture = textureLoader.load('./wall/castle_wall_slates_1k/castle_wall_slates_nor_gl_1k.webp')
...
const gravesCount = { count: 30 }
const generateGraves = () => {
  while (graves.children.length) {
    graves.remove(graves.children[0])
  }
  for (let i = 0; i < gravesCount.count; i++) {
...
ghostsTweaks.addColor(ghost1, 'color').name('ghost1Color')
ghostsTweaks.addColor(ghost2, 'color').name('ghost2Color')
ghostsTweaks.addColor(ghost3, 'color').name('ghost3Color')
 ...
 * Fog
 */
const fogValues = {densityValue: 0.1, colorValue: '#02343f'}

// scene.fog = new THREE.Fog('#ff0000', 1, 13)
scene.fog = new THREE.FogExp2(fogValues.colorValue, fogValues.densityValue)

fogTweaks.add(fogValues, 'densityValue').min(0).max(0.5).step(0.001).onFinishChange(() => {
  scene.fog.density = fogValues.densityValue
})
fogTweaks.addColor(fogValues, 'colorValue').onFinishChange(() => {
  scene.fog.color.set(fogValues.colorValue)
})
